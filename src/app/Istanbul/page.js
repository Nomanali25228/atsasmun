...
export default function Page() {
  return (
    <>
      <Dubaih bgImage={istanbul} tital="Istanbul, Turkey" Pricelink="/Istanbulfee" StartDays="28" sup="th" EndDays="31" sup1="st" monthsDetils="August 2025 G Rotana Hotel" style="text-blue-400" stlyle2="hover:text-blue-400"/>
