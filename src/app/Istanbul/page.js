...
import hotelx1 from '@/app/public/img/bgHotelVenueIstanbul1.jpg';
import hotelx2 from '@/app/public/img/HotelVenueIstanbul2.jpg';
import hotelx3 from '@/app/public/img/HotelVenueIstanbul3.jpg';
import hotelx4 from '@/app/public/img/HotelVenueIstanbul4.jpg';
import hotelx5 from '@/app/public/img/HotelVenueIstanbul5.jpg';
...
export default function Page() {
  return (
    <>
      <Dubaih bgImage={istanbul} tital="Istanbul, Turkey" Pricelink="/Istanbulfee" StartDays="12" sup="th" EndDays="15" sup1="th" monthsDetils="June 2025 G Rotana Hotel" style="text-blue-400" stlyle2="hover:text-blue-400"/>
      ...
      <Map bgimg5={hotelx1} img1={hotelx4} img2={hotelx3} img3={hotelx2}  img4={hotelx5} map="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2510.9473144053363!2d28.809779175186865!3d41.05945921627315!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14caa5d52a209bfd%3A0xc941d8ad912e1418!2sG%20Rotana!5e1!3m2!1sen!2sus!4v1744738203590!5m2!1sen!2sus"  hname="G Rotana Hotel." disc="Our goal is to be recognized in Turkey and Istanbul for our service and quality, combining global standards with Turkish hospitality to be the top choice for guests. G Rotana Hotel also aims to expand its investments in the thriving tourism and hotel industry."/>
