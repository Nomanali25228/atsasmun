...
export default function Page() {
  return (
    <>
      <Dubaih bgImage={istanbul} tital="Istanbul, Turkey" Pricelink="/Istanbulfee" StartDays="11" sup="th" EndDays="14" sup1="th" monthsDetils="September 2025 G Rotana Hotel" style="text-blue-400" stlyle2="hover:text-blue-400"/>
