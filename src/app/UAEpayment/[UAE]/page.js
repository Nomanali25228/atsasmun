        ...
        const fetchData = async () => {
            try {
                const response = await fetch(
                    `https://atsas-backend.onrender.com/api/secondenames?filters[id][$eq]=${id}`
                );
                if (!response.ok) {
                ...
                console.log("Fetched Data:", result.data[0].DateBirth); // Assuming it returns an array
