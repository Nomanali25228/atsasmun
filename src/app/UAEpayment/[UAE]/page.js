...
export default function Page() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const url = `/api1/api/secondenames?filters[userid][$eq]=${id}`;
                ...
                toast.error("Failed to fetch user details. Check your Link or Internet.");
            }
        };
    ...
    const handleCreateInvoice = async (su) => {
        ...
        setLoader(true)
        let non = su === 459 ? "Non-Accommodation" : "Accommodation";
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-xs text-gray-500 mt-1">
                                            <span className="line-through">$559</span>  Early Applicant Discount
                                        </p>
                                    </div>
                                            ...
                                            {showOptions1 && (
                                                <div className="mt-4 space-y-2">
                                                    ...
                                                    {!loader1 && <button
                                                        ...
                                                        onClick={() => handleCreateInvoice(459)}>
                                                        Invoice ↓
                                                    </button>}
                                                </div>
                                            )}
                                        ...
                                        <div ref={optionsRef} className="relative">
                                            ...
                                            {showOptions2 && (
                                                <div className="mt-4 space-y-2">
                                                    ...
                                                    {!loader && <button
                                                        className="w-full py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white text-sm font-bold rounded-full hover:scale-105 transition-all duration-300"
                                                        onClick={() => handleCreateInvoice(679)}>
                                                        Invoice ↓
                                                    </button>}
                                                </div>
                                            )}
