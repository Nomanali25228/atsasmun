                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="background-color:#fff;  box-shadow:0 4px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td align="center" style="text-align: center;
                            ...
                            <p style="margin:6px 0 0; font-size:18px; color: #ffffff !important; -webkit-text-fill-color: #ffffff !important;">for Dubai, UAE</p>
                ...
                <table style="width: 100%; max-width: 800px; margin: 40px auto; text-align: center; padding: 20px; background: #f9f9f9; border-radius: 10px; border-collapse: collapse;">
                    ...
                    <tr>
                        <td align="center" style="background-color:#003366; color:#fff; padding:20px;">
                            <p style="margin:0; font-size:14px;">Atsas MUN UAE &copy; 2024 Atsas Creation International Ltd</p>
...
//                 We are grateful to inform you that you have been selected to join the Atsas International MUN Dubai, UAE
//                 2025 United Nations Simulation Conference Crafting Future Leaders in the Post-Pandemic Era, to be held
//                 from 22th to 25th May 2025 in Dubai, UAE.
//               </p>
...
//                 <strong>Duration of stay:</strong> 22<sup>th</sup> – 25<sup>th</sup> May, 2025<br />
//                 <strong>Venue:</strong> Meydan Hotel, Meydan, Dubai, UAE<br />
//                 <strong>Destination:</strong> Dubai, UAE
//               </p>

//               <p style="color:#333333;">
//                 <em>You are requested to pay your delegate fee in order to become a confirmed delegate at Atsasmun Dubai
//                   on the following link:</em><br />
//                 <a href="https://www.atsasmun.com/UAEpayment/1?userid=${id}" style="color:#003c71;">
//                   https://www.atsasmun.com/UAEpayment
//                 </a>
//               </p>
...
//                   and flight ticket to and from Dubai, UAE.
//                 </li>
//                 <li>
//                   We will accommodate your Visa Invitation Letter.
//                 </li>
//                 <li>
//                   We provide visa services for Dubai, UAE.
//                 </li>
//                 <li>
//                   Hotel check-in will be on 22th May 2025 and check-out on
//                   25th May 2025, except for those who will be taking the Full
//                   Experience Package.
//                 </li>
//                 <li>
...
//                 kind attention. Looking forward to seeing you in Dubai, UAE.
//               </p>
...
//                                         <p style="margin:0; font-size:14px;">Atsas MUN UAE &copy; 2024 Atsas Creation
//                                             International Ltd</p>
