                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="background-color:#fff;  box-shadow:0 4px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td align="center" style="padding:20px;">
                            <h2 style="margin:0; font-size:20px; color:#000;">Date: 12th-15th june, 2025</h2>
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
            <tr>
                ...
                <td align="center" style="width: 48%; padding: 1px; vertical-align: middle; ">
                    ...
                    <tr>
                        <td align="center" style="padding:20px;">
                            <a href="https://www.atsasmun.com/Istanbulpayment/1?userid=${id}" style=" background: linear-gradient(to right, #00509E, #003A70, #002855); color:#fff; text-decoration:none; padding:10px 30px; border-radius:5px; font-size:16px; display:inline-block;">
 ...
 <table
                        ...
                        <tr>
                            <td>
                                     ...
                                     <a href="https://www.atsasmun.com/Istanbulpayment/1?userid=${id}"
                            ...
                            <table style="margin: 0 auto; text-align: center; border-collapse: collapse;">
                                <tr>
                                    <td style="padding: 10px;">
                                         <a href="facebooks" target="_blank" style="text-decoration: none; color: #333; display: flex; align-items: center; gap: 10px;">
                ...
                <table style="width: 100%; max-width: 800px; margin: 40px auto; text-align: center; padding: 20px; background: #f9f9f9; border-radius: 10px; border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="padding: 10px; font-size: 17px; color: #000000;">
                             <a href="mailto:atsasmun@gmail.com" target="_blank" style="text-decoration: underline;  font-weight: bold; color: #000000;">turkiye@atsasmun.com</a>
                    ...
                    <tr>
                        <td style="padding: 20px; font-size: 1rem; color: black; font-weight: bold;">
                            We look forward to meeting you in Istanbul, Turkiye!
                        </td>
                    </tr>
...
//                 We are grateful to inform you that you have been selected to join the Atsas International MUN Istanbul, Turkey
//                 2025 United Nations Simulation Conference Crafting Future Leaders in the Post-Pandemic Era, to be held
//                 from 12th to 15th June 2025 in Istanbul, Turkey.
//               </p>
...
//                 <strong>Duration of stay:</strong> 12<sup>th</sup> – 15<sup>th</sup> June, 2025<br />
//                 <strong>Venue:</strong> G Rotana Hotel Istanbul, Turkey <br />
//                 <strong>Destination:</strong> Istanbul, Turkey
//               </p>
...
//                 <a href="https://www.atsasmun.com/Istanbulpayment/1?userid=${id}" style="color:#003c71;">
//                   https://www.atsasmun.com/Istanbulpayment
//                 </a>
//               </p>
...
//                   and flight ticket to and from Istanbul, Turkey
// .
//                 </li>
//                 <li>
...
//                 </li>
//                 <li>
//                   Hotel check-in will be on 12th June 2025 and check-out on
//                   15th June 2025, except for those who will be taking the Full
//                   Experience Package.
//                 </li>
//                 <li>
...
//                 kind attention. Looking forward to seeing you in Istanbul, Turkey.
//               </p>
...
//                             You have been selected as one of the delegates at AtsasMUN Istanbul, Turkey
...
//                             You have been recognized as an Early Bird Applicant and are eligible for free airport Assistance in the host country on your arrival for AtsasMUN Turkey.
//                         </p>
//                     </td>
//                 </tr>
...
//                                              <a href="http://localhost:3000/Istanbulpayment/1?userid=${id}"
//                                             style="display: inline-block; padding: 10px 100px; font-size: 16px; font-weight: bold; color: #fff; text-decoration: none;  background: linear-gradient(to right, #00509E, #003A70, #002855);">Pay
//                                             Now</a>
//                                     </td>
//                                 </tr>
...
//                                         Should you have any questions, feel free to reach us at
//                                         <a href="mailto:atsasmun@gmail.com" target="_blank"
//                                             style="text-decoration: underline;  font-weight: bold; color: #000000;">turkiye@atsasmun.com</a>
