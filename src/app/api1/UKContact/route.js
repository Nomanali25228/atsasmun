...
console.log("nodemailer id",id);
        ...
        if (destination == "Dubai, UAE") {
            ...
            link2o = "http://localhost:3000/UKpayment/1";
                   ...
                   <tr>
                    ...
                    <tr>
                        <td align="center" style="padding:20px;">
                            <h2 style="margin:0; font-size:20px; color:#000;">Date: 20th–24th November, 2025</h2>
...
; color: white; padding: 10px; font-size: 16px; font-weight: bold; border-radius: 0 8px 0 0; text-align: center;">
                    ...
                    <tr>
                        <td align="center" style="background-color:#003366; color:#fff; padding:20px;">
                            <p style="margin:0; font-size:14px;">Atsas MUN London, UK © 2024 Atsas Creation
                                International Ltd</p>
...
//                 <strong>Duration of stay:</strong> 07<sup>nth</sup> – 10<sup>th</sup> october, 2025<br />
