...
console.log("nodemailer id",id);
        ...
        if (destination == "Dubai, UAE") {
            ...
            link2o = "https://www.atsasmun.com/UKpayment/1";
                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0"
                   ...
                   <tr>
                        <td align="center" style="text-align: center;
                            ...
                            <p style="margin:6px 0 0; font-size:18px; color: #ffffff !important; -webkit-text-fill-color: #ffffff !important;">for London, UK</p>
                    ...
                    <tr>
                        <td align="center" style="padding:20px;">
                            <h2 style="margin:0; font-size:20px; color:#000;">Date: ${startdate === 'Coming Soon' ? 'Coming Soon' : `${startdate === 'Coming Soon' ? 'Coming Soon' : `${startdate}&ndash;${enddate} ${month}, ${year}`}`}</h2>
                                ...
                                <tr>
                                    ...
                                    <td align="center" style="width: 48%; padding: 1px; vertical-align: middle; ;">
                                        <img src="https://6e77be9065.imgdist.com/pub/bfra/izj5d9lu/4wi/59y/4ps/images-removebg-preview.png"
                                            ...
                                            style="display: block; margin-bottom: 12px; margin-top: 0px;">
...
; color: white; padding: 10px; font-size: 16px; font-weight: bold; border-radius: 0 8px 0 0; text-align: center;">
                    ...
                    <table
                        ...
                        <tr>
                            <td style="padding: 20px; font-size: 1rem; color: black; font-weight: bold;">
                                We look forward to meeting you in London, UK!
                            </td>
                        </tr>
                    ...
                    <tr>
                        <td align="center" style="background-color:#003366; color:#fff; padding:20px;">
                            <p style="margin:0; font-size:14px;">Atsas MUN London, UK &copy; 2024 Atsas Creation
                                International Ltd</p>
...
//                 We are grateful to inform you that you have been selected to join the Atsas International MUN London, UK
//                 2025 United Nations Simulation Conference Crafting Future Leaders in the Post-Pandemic Era, to be held
//                 from 07th to 10th August 2025 in London, UK.
//               </p>
...
//                 <strong>Duration of stay:</strong> 07<sup>nth</sup> &ndash; 10<sup>th</sup> october, 2025<br />
//                 <strong>Venue:</strong> Sunway Putra Hotel London, UK <br />
//                 <strong>Destination:</strong> London, UK
//               </p>
...
//                 <a href="https://www.atsasmun.com/UKpayment/1?userid=${id}" style="color:#003c71;">
//                   https://www.atsasmun.com/UKpayment
//                 </a>
//               </p>
...
//                   and flight ticket to and from London, UK
// .
//                 </li>
//                 <li>
...
//                 </li>
//                 <li>
//                   We provide visa services for London, UK
// .
//                 </li>
//                 <li>
//                   Hotel check-in will be on 07th June 2025 and check-out on
//                   10th June 2025, except for those who will be taking the Full
//                   Experience Package.
//                 </li>
//                 <li>
...
//                 kind attention. Looking forward to seeing you in London, UK.
//               </p>
...
//                     You have been selected as one of the delegates at AtsasMUN London, UK
...
//                     You have been recognized as an Early Bird Applicant and are eligible for free airport Assistance in the host country on your arrival for AtsasMUN UK.
//                 </p>
//             </td>
//         </tr>
...
//                                            <a href="http://localhost:3000/Francepayment/1?userid=${id}"
//                                     style="display: inline-block; padding: 10px 100px; font-size: 16px; font-weight: bold; color: #fff; text-decoration: none;  background: linear-gradient(to right, #00509E, #003A70, #002855);">Pay
//                                     Now</a>
//                             </td>
//                         </tr>
