                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                        ...
                        background-position: center; color:#fff; padding:70px;">
                            ...
                            <p style="margin:6px 0 0;   font-size:18px;  color: white; ">for Paris, France</p>
...
; color: white; padding: 10px; font-size: 16px; font-weight: bold; border-radius: 0 8px 0 0; text-align: center;">
                     ...
                     <table
                        ...
                        <tr>
                            <td>
                                           ...
                                           <a href="https://www.atsasmun.com/Francepayment/1?userid=${id}"
                    ...
                    <table
                        ...
                        <tr>
                            <td style="padding: 20px; font-size: 1rem; color: black; font-weight: bold;">
                                We look forward to meeting you in Paris, France!
                            </td>
                        </tr>
                    ...
                    <tr>
                        <td align="center" style="background-color:#003366; color:#fff; padding:20px;">
                            <p style="margin:0; font-size:14px;">Atsas MUN Paris, France © 2024 Atsas Creation
                                International Ltd</p>
...
//                     You have been selected as one of the delegates at AtsasMUN Paris, France
...
//                     You have been recognized as an Early Bird Applicant and are eligible for free airport Assistance in the host country on your arrival for AtsasMUN Paris, France.
//                 </p>
//             </td>
//         </tr>
