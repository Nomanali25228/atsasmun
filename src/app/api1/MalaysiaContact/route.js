                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="background-color:#fff;  box-shadow:0 4px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        ...
                        background-position: center; color:#fff; padding:70px;">
                            ...
                            <p style="margin:6px 0 0;   font-size:18px;  color: white; ">for Kuala Lumpur, Malaysia</p>
                    ...
                    <tr>
                        <td align="center" style="padding:20px;">
                            <h2 style="margin:0; font-size:20px; color:#000;">Date: 01st-04th may, 2025</h2>
                    ...
                    <table
                        ...
                        <tr>
                            <td>
                                ...
                                <a href="https://www.atsasmun.com/Malaysiapayment/1?userid=${id}"
                ...
                <table style="width: 100%; max-width: 800px; margin: 40px auto; text-align: center; padding: 20px; background: #f9f9f9; border-radius: 10px; border-collapse: collapse;">
                    ...
                    <tr>
                        <td align="center" style="background-color:#003366; color:#fff; padding:20px;">
                            <p style="margin:0; font-size:14px;">Atsas MUN Malaysia © 2024 Atsas Creation International Ltd</p>
...
//                     You have been selected as one of the delegates at AtsasMUN Kuala Lumpur, Malaysia
...
//                     You have been recognized as an Early Bird Applicant and are eligible for free airport Assistance in the host country on your arrival for AtsasMUN Malaysia.
//                 </p>
//             </td>
//         </tr>
...
//                                 <a href="http://localhost:3000/Malaysiapayment/1?userid=${id}"
//                                     style="display: inline-block; padding: 10px 100px; font-size: 16px; font-weight: bold; color: #fff; text-decoration: none;  background: linear-gradient(to right, #00509E, #003A70, #002855);">Pay
//                                     Now</a>
//                             </td>
//                         </tr>
...
//                                 <p style="margin:0; font-size:14px;">Atsas MUN Malaysia © 2024 Atsas Creation
//                                     International Ltd</p>
