                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="background-color:#fff;  box-shadow:0 4px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td align="center" style="text-align: center;
                            ...
                            <p style="margin:6px 0 0; font-size:18px; color: white;">for Riyadh, Saudi Arabia</p>
                    ...
                    <tr>
                        <td align="center" style="padding:20px;">
                            <h2 style="margin:0; font-size:20px; color:#000;">Date: 16th-19th october, 2025</h2>
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
            <tr>
                ...
                <td align="center" style="width: 48%; padding: 1px; vertical-align: middle; ">
                    ...
                    <tr>
                        <td align="center" style="padding:20px;">
                            <a href="https://www.atsasmun.com/Saudipayment/1?userid=${id}" style=" background: linear-gradient(to right, #00509E, #003A70, #002855); color:#fff; text-decoration:none; padding:10px 30px; border-radius:5px; font-size:16px; display:inline-block;">
...
<table style="width: 100%; font-family: Arial, sans-serif; line-height: 1.6; margin-top: 20px; padding: 0;  background: #f2f4f7bb; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); color: #333; text-align: center;">
    ...
    <tr>
        <td colspan="3" style="max-width: 800px; margin: 40px auto; text-align: center; padding:0px 10px;">
            ...
            <p style="font-size:16px; color: #555; margin-bottom: 20px;">
                AtsasMUN has integrated 1 committees into its conferences. The esteemed members of our secretariat are highly talented and dedicated to ensuring a seamless experience for all participants.
            </p>
    ...
    <tr>
        <td style="text-align: center; padding: 10px;">
            ...
            <h4 style="font-size: 16px; margin-top: 10px; color: #2c3e50;">United Nations General assembly</h4>
        </td>
...
; color: white; padding: 10px; font-size: 16px; font-weight: bold; border-radius: 0 8px 0 0; text-align: center;">
   ...
   <table
                        ...
                        <tr>
                            <td>
                                         <a href="https://www.atsasmun.com/Saudipayment/1?userid=${id}"
                ...
                <table style="width: 100%; max-width: 800px; margin: 40px auto; text-align: center; padding: 20px; background: #f9f9f9; border-radius: 10px; border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="padding: 20px; font-size: 1rem; color: black; font-weight: bold;">
                            We look forward to meeting you in Riyadh, Saudi Arabia!
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="background-color:#003366; color:#fff; padding:20px;">
                            <p style="margin:0; font-size:14px;">Atsas MUN Riyadh, Saudi Arabia © 2024 Atsas Creation International Ltd</p>
...
//                 We are grateful to inform you that you have been selected to join the Atsas International MUN Riyadh, Saudi Arabia
//                 2025 United Nations Simulation Conference Crafting Future Leaders in the Post-Pandemic Era, to be held
//                 from 16th to 19th october 2025 in Riyadh, Saudi Arabia.
//               </p>
...
//                 <strong>Duration of stay:</strong> 16<sup>nth</sup> – 19<sup>th</sup> october, 2025<br />
//                 <strong>Venue:</strong> Hilton Riyadh Hotel Riyadh, Saudi Arabia <br />
//                 <strong>Destination:</strong> Riyadh, Saudi Arabia
//               </p>
...
//                 <a href="https://www.atsasmun.com/Saudipayment/1?userid=${id}" style="color:#003c71;">
//                   https://www.atsasmun.com/Saudipayment
//                 </a>
//               </p>
...
//                   and flight ticket to and from Riyadh, Saudi Arabia
// .
//                 </li>
//                 <li>
...
//                 </li>
//                 <li>
//                   We provide visa services for Riyadh, Saudi Arabia
// .
//                 </li>
//                 <li>
//                   Hotel check-in will be on 16th June 2025 and check-out on
//                   19th June 2025, except for those who will be taking the Full
//                   Experience Package.
//                 </li>
//                 <li>
...
//                 kind attention. Looking forward to seeing you in Riyadh, Saudi Arabia.
//               </p>
...
//                             You have been selected as one of the delegates at AtsasMUN Riyadh, Saudi Arabia
...
//                             You have been recognized as an Early Bird Applicant and are eligible for free airport Assistance in the host country on your arrival for AtsasMUN  Saudi Arabia.
//                         </p>
//                     </td>
//                 </tr>
...
//                                 <tr>
//                                     <td>
//                                                  <a href="http://localhost:3000/ Saudi Arabiapayment/1?userid=${id}"
//                                             style="display: inline-block; padding: 10px 100px; font-size: 16px; font-weight: bold; color: #fff; text-decoration: none;  background: linear-gradient(to right, #00509E, #003A70, #002855);">Pay
//                                             Now</a>
//                                     </td>
//                                 </tr>
...
//                                         <p style="margin:0; font-size:14px;">Atsas MUN Riyadh, Saudi Arabia © 2024 Atsas Creation
//                                             International Ltd</p>
