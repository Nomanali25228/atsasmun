                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="background-color:#fff;  box-shadow:0 4px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        ...
                        background-position: center; color:#fff; padding:70px;">
                            ...
                            <p style="margin:6px 0 0;   font-size:18px;  color: white; ">for Geneva, Switzerland</p>
                    ...
                    <tr>
                        <td align="center" style="padding:20px;">
                            <h2 style="margin:0; font-size:20px; color:#000;">Date: 03rd-06th July, 2025</h2>
...
; color: white; padding: 10px; font-size: 16px; font-weight: bold; border-radius: 0 8px 0 0; text-align: center;">
   ...
   <table
                        ...
                        <tr>
                            <td>
                                         <a href="https://www.atsasmun.com/Switzerlandpayment/1?userid=${id}"
                ...
                <table style="width: 100%; max-width: 800px; margin: 40px auto; text-align: center; padding: 20px; background: #f9f9f9; border-radius: 10px; border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="padding: 20px; font-size: 1rem; color: black; font-weight: bold;">
                            We look forward to meeting you in Geneva, Switzerland!
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="background-color:#003366; color:#fff; padding:20px;">
                            <p style="margin:0; font-size:14px;">Atsas MUN Geneva, Switzerland © 2024 Atsas Creation International Ltd</p>
...
//                     You have been selected as one of the delegates at AtsasMUN Geneva, Switzerland
...
//                     You have been recognized as an Early Bird Applicant and are eligible for free airport Assistance in the host country on your arrival for AtsasMUN Switzerland.
//                 </p>
//             </td>
//         </tr>
...
//                         <tr>
//                             <td>
//                                          <a href="http://localhost:3000/Switzerlandpayment/1?userid=${id}"
//                                     style="display: inline-block; padding: 10px 100px; font-size: 16px; font-weight: bold; color: #fff; text-decoration: none;  background: linear-gradient(to right, #00509E, #003A70, #002855);">Pay
//                                     Now</a>
//                             </td>
//                         </tr>
...
//                                 <p style="margin:0; font-size:14px;">Atsas MUN Geneva, Switzerland © 2024 Atsas Creation
//                                     International Ltd</p>
