...
export default function Page() {
  ...
  return (
    <>
      <Dubaih bgImage={london} tital="London, UK" Pricelink="/UKfee" StartDays="20" sup="th" EndDays="24" sup1="th" monthsDetils="November, 2025, Hilton London Heathrow Airport Terminal 5" style="text-blue-400" stlyle2="hover:text-blue-400" />
