...
export default function Page() {
  ...
  return (
    <>
      <Dubaih bgImage={london} tital="London, UK" Pricelink="/UKfee" StartDays="7" sup="th" EndDays="10" sup1="th" monthsDetils="August, 2025, Sunway Putra Hotel" style="text-blue-400" stlyle2="hover:text-blue-400" />
