...
export default function Page() {
  ...
  return (
    <>
      <Dubaih bgImage={Azerbaijan} tital="Baku, Azerbaijan" Pricelink="/Azerbaijanfee" StartDays="6" sup="th" EndDays="9" sup1="th" monthsDetils="November, 2025, Hilton Baku" style="text-blue-400" stlyle2="hover:text-blue-400" />
