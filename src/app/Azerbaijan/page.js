...
export default function Page() {
  ...
  return (
    <>
      <Dubaih bgImage={Azerbaijan} tital="Baku, Azerbaijan" Pricelink="/Azerbaijanfee" StartDays="28" sup="th" EndDays="31" sup1="st" monthsDetils="August, 2025, Hilton Baku" style="text-blue-400" stlyle2="hover:text-blue-400" />
      <AboutDubai aboutTitle="Baku" about="ATSASMUN Baku offers a unique platform to experience diplomacy in a city where history meets modern ambition. Nestled on the shores of the Caspian Sea, Baku blends ancient charm with cutting-edge progress. Delegates will engage in dynamic discussions, tackle global issues, and collaborate in a setting that reflects the spirit of resilience and innovation. With diverse committees and impactful topics, this conference promises a transformative experience in the heart of Azerbaijan." /> {/* Corrected prop passing */}
      <Desert heading="Baku City Tour" Desert={BAkuCity1} Desert2={BAkuCity2} Desert3={BAkuCity3} />
      <Map bgimg5={hotelx4} img1={hotelx2} img2={hotelx3} img3={hotelx1} img4={hotelx5} map="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d2537.0060343690843!2d49.8496777!3d40.372112!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40307dac39cb4bf1%3A0xbabf0162238cc76f!2sHilton%20Baku!5e1!3m2!1sen!2s!4v1748602221963!5m2!1sen!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" hname="Hilton Baku" disc="At the heart of Baku's business district, overlooking the Caspian Sea. Steps from Baku Boulevard, Park Bulvar Mall, and two kilometers from Old Town. Enjoy family time, a full-service spa, and a rooftop bar with views."/>
