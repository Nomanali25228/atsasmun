...
export default function Dubaih(props) {
  ...
  const [mla, setMla] = useState(tital)

  const { check, setCheck } = useContext(ContextPage)
  console.log(check, "lollk");
  useEffect(() => {
  ...
  return (
    <div id="banner"
          ...
          <div className="hidden lg:flex items-center space-x-5 ml-24 text-sm font-medium text-[#A8ABBA]">
            ...
            >
              <button className="flex items-center space-x-1 text-white">
                ...
                <AiOutlineDown className="text-white text-xs" />
              </button>
              ...
              {dropdownOpen2 && (
                <div className="absolute w-[200px]  mt-4 bg-white text-black rounded shadow-lg">
                  ...
                  <Link href="/londonLandingP" className={`block px-4 py-2 ${mla == "London, UK" ? style : stlyle2} `}>
                    London, UK
                  </Link>
                  <Link href="/switzerlandLandingP" className={`block px-4 py-2 ${mla == "Geneva, Switzerland" ? style : stlyle2} `}>
                    Geneva, Switzerland
                  </Link>
                  <Link href="/franceLandingP" className={`block px-4 py-2 ${mla == "Paris, France" ? style : stlyle2} `}>
                    Paris, France
                  </Link>
      ...
      <div
        className="relative  bg-cover bg-center bg-no-repeat w-full h-screen text-white"
      ...
      >
        ...
        <div className="relative  max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          {/* Tagline */}
          {/* <div className="text-sm relative z-10 sm:text-md uppercase tracking-wide bg-[#111827] px-3 py-1 inline-block rounded-full mb-8 sm:mb-12">
            Forging a world of unity and peace
          </div> */}

          {/* Main Heading */}
          <h1 className="text-3xl mt-36 relative z-10 sm:text-4xl lg:text-6xl font-bold leading-tight text-center sm:text-left">
            ATSAS MUN <br />
            <div className="sm:flex ">
              <span className="text-[#027CAC]">{mla}</span>
              {/* Play Button */}
              <span
                className="ml-2 mt-2 flex justify-center items-center cursor-pointer hover:text-[#027CAC] transition"
      ...
      {/* {isVideoVisible && (
        <div className="fixed inset-0 bg-black bg-opacity-80 z-50 flex justify-center items-center px-4 sm:px-6">
          <div className="relative w-full max-w-4xl">
            ...
            ></video>
            <button
              className="absolute top-2 right-2 text-white text-2xl hover:text-[#1E88E5]"
