...
export default function Page(props) {
  ...
  return (
    <>
      <Dubaih bgImage={bgUSA} tital="New York, USA" Pricelink="/USAfee" StartDays="25" sup="th" EndDays="28" sup1="th" monthsDetils="September, 2025, East Brunswick Hotel" style="text-blue-400" stlyle2="hover:text-blue-400" />
