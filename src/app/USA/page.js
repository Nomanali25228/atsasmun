...
export default function Page(props) {
  ...
  return (
    <>
      <Dubaih bgImage={bgUSA} tital="New York, USA" Pricelink="/USAPrice" StartDays="04" sup="th" EndDays="07" sup1="th" monthsDetils="September, 2025, East Brunswick Hotel" style="text-blue-400" stlyle2="hover:text-blue-400" />
      <AboutDubai aboutTitle="New York" about="ATSASMUN New York offers an unparalleled opportunity to engage in dynamic diplomacy at the heart of global influence—Times Square. Surrounded by the energy of the city that never sleeps and just steps from the United Nations headquarters, delegates will experience bold dialogue in a truly iconic setting. With diverse committees and thought-provoking topics, this conference promises an unforgettable and empowering experience, where the pulse of international relations beats strongest." /> {/* Corrected prop passing */}
      <Desert heading="New York City Tour" Desert={USAcity1} Desert2={USAcity2} Desert3={USAcity3} />
      <Map bgimg5={hotelx1} img1={hotelx2} img2={hotelx3} img3={hotelx4} img4={hotelx5} map="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2532.9363860928624!2d-74.41136332484642!3d40.48009165178186!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c3c621c111af0f%3A0xf6a3d20dff5c4484!2sHilton%20East%20Brunswick%20Hotel%20%26%20Executive%20Meeting%20Center!5e1!3m2!1sen!2s!4v1742234247488!5m2!1sen!2s" hname="Brunswick Hotel" disc="This modern hotel is just six miles east of New Brunswick, NJ—the home of Rutgers University. It is straight off the New Jersey Turnpike, which connects you to New York within an hour. Enjoy our heated indoor pool, whirlpool, and fitness center. We also serve Starbucks® coffee in the lobby cafe." />
