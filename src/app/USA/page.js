...
export default function Page(props) {
  ...
  return (
    <>
      <Dubaih bgImage={bgUSA} tital="New York, USA" Pricelink="/USAfee" StartDays="12" sup="th" EndDays="15" sup1="th" monthsDetils="February, 2026, East Brunswick Hotel" style="text-blue-400" stlyle2="hover:text-blue-400" />
