...
//                      `https://atsas-backend.onrender.com/api/fivthnames?filters[id][$eq]=${id}`
//                  );
//                  if (!response.ok) {
...
//                             Pricing for <span className="text-purple-400">Paris, France </span>
//                         </h2>
