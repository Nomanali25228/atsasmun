...
// Helper function to convert to sub-currency (e.g., cents)
...
export default function Home() {
  ...
  useEffect(() => {
    if (!localStorage.getItem('amounts') || localStorage.getItem('amounts') <= 0) {
      router.push("/"); 
    }
  }, [amounts, router]);
  ...
  // Only render the payment page if the amount is valid
