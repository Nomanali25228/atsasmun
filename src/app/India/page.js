...
export default function Page() {
  ...
  return (
    <>
      <Dubaih bgImage={India} tital="Goa, India" Pricelink="/IndiaPrice" StartDays="26" sup="th" EndDays="29" sup1="th" monthsDetils="June, 2025, Grand Hyatt Goa" style="text-blue-400" stlyle2="hover:text-blue-400" />
