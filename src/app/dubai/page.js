...
export default function Page() {
  ...
  return (
    <>
      <Dubaih bgImage={dubai} tital="Dubai, UAE" Pricelink="/uaePrice" StartDays="24" sup="th" EndDays="27" sup1="th" monthsDetils="April, 2025, Meydan Hotel, Meydan" style="text-blue-400" stlyle2="hover:text-blue-400" />
