...
//   return (
//     <>
//       <Dubaih bgImage={dubai} tital="Dubai, UAE" Pricelink="/uaefee" StartDays="14" sup="th" EndDays="17" sup1="th" monthsDetils="August, 2025, Meydan Hotel, Meydan" style="text-blue-400" stlyle2="hover:text-blue-400" />
