...
export default function Page() {
  ...
  return (
    <>
      <Dubaih bgImage={dubai} tital="Dubai, UAE" Pricelink="/uaefee" StartDays="2" sup="nd" EndDays="05" sup1="th" monthsDetils="May, 2025, Meydan Hotel, Meydan" style="text-blue-400" stlyle2="hover:text-blue-400" />
